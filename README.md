...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 100; position: fixed; top: 0; left: 0; height: 10vh; object-fit: cover; background-size: cover; width: 10vw; opacity: 1.0; background: url('https://github.com/0zbug/0zbug/blob/main/bug_spin_transparent.gif?raw=true');]{x0000}$}
